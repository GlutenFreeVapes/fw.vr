...
private _button1 = ["Heal myself",[0.5,1.5,6,1],"[player,player] call ace_medical_treatment_fnc_fullHeal;",-1]call menus_fnc_addButton;
_button1 ctrlSetTooltip "You little cheat";

private _button2 = ["Heal everyone",[0.5,3,6,1],"
private _nil = {[player,_x] call ace_medical_treatment_fnc_fullHeal;false} count (allPlayers - entities 'HeadlessClient_F');
